...
class MainWidget(RelativeLayout):
    ...
    menu_title =StringProperty("N   E   X    I   U   M")
    ...
    def init_audio(self):
        ...
        self.sound_galaxy=SoundLoader.load('audio/test2.mp3')
        self.sound_gameover_impact=SoundLoader.load('audio/impact2.mp3')
        self.sound_gameover_voice=SoundLoader.load('audio/youlost.wav')
        self.sound_music1=SoundLoader.load('audio/Fly Away.mp3')
